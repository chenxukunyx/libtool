...
public class RoundedCornersTransformation implements Transformation<Bitmap> {
    ...
    public RoundedCornersTransformation(Context context, int radius, int margin, int bgColor,
                                        CornerType cornerType, Bitmap.Config bitmapConfig) {
        this(Glide.get(context).getBitmapPool(), radius, margin, bgColor, cornerType, bitmapConfig);
    }

    public RoundedCornersTransformation(BitmapPool pool, int radius, int margin, int bgColor,
                                        CornerType cornerType, Bitmap.Config bitmapConfig) {
        mBitmapPool = pool;
        mRadius = radius;
        mDiameter = mRadius * 2;
