...
import com.shentu.lib_view.banner.listener.OnBannerListener;
import com.shentu.lib_view.banner.loader.ImageLoaderInterface;
import com.shentu.lib_view.banner.view.BannerViewPager;
...
//                Log.i(tag, "curr:" + currentItem + " count:" + count);
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        bannerBackgroundImage = typedArray.getResourceId(R.styleable.Banner_banner_default_image, R.drawable.nim_image_default);
        typedArray.recycle();
    }
