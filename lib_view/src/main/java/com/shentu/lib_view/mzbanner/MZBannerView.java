package com.shentu.lib_view.mzbanner;
...
import com.shentu.lib_view.R;
import com.shentu.lib_view.mzbanner.holder.MZHolderCreator;
import com.shentu.lib_view.mzbanner.holder.MZViewHolder;
import com.shentu.lib_view.mzbanner.transformer.CoverModeTransformer;
import com.shentu.lib_view.mzbanner.transformer.ScaleYTransformer;
    ...
    private void initIndicator(){
        ...
        for(int i=0;i<mDatas.size();i++){
            ...
            if(mIndicatorAlign == IndicatorAlign.LEFT.ordinal()){
                ...
                imageView.setPadding(6,0,6,mIndicatorPaddingBottom);
            } else {
                imageView.setPadding(6,0,6,0);
            }
