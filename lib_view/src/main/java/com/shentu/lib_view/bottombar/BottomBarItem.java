...
public class BottomBarItem extends LinearLayout {
    ...
    private void initAttrs(TypedArray ta) {
        ...
        titleNormalColor = ta.getColor(R.styleable.BottomBarItem_textColorNormal, UIUtils.getColor(context,R.color.bbl_ffffff));
        titleSelectedColor = ta.getColor(R.styleable.BottomBarItem_textColorSelected, UIUtils.getColor(context,R.color.bbl_e24848));
    ...
    public static final class Builder {
        ...
        public Builder(Context context) {
            ...
            titleNormalColor = getColor(R.color.bbl_ffffff);
            titleSelectedColor = getColor(R.color.bbl_e24848);
